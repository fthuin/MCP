...
En effet, nous savons que $i$ peut prendre $\frac{B}{PGCD(A,B)}$ valeurs différentes et c peut prendre $PGCD(A,B)$ valeur différentes. Donc $x_{i,c}$ peut prendre $B$ valeurs différents.\\
